...
B = 13.5              #Distance between the cameras [cm]
f = 8              #Camera lense's focal length [mm]
alpha = 78      #Camera field of view in the horizontal plane [degrees]
# alphaR = 69.4
...
with mp_facedetector.FaceDetection(min_detection_confidence=0.7) as face_detection:
    ...
    ################## CALIBRATION #########################################################
        ...
        # frame_left, frame_right = calibration.undistortRectify(frame_left, frame_right)
